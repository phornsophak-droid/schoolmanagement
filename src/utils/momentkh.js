/* eslint-disable */
// @ts-nocheck
// Vendored from ThyrithSor/momentkh (MIT) — standalone Khmer (Chhankitek) calendar.
// UMD wrapper converted to a plain IIFE so it can be re-exported as an ES module.
const momentkh = (function () {
...
export const fromDate = momentkh.fromDate;
export const fromGregorian = momentkh.fromGregorian;
export const format = momentkh.format;
export const getNewYear = momentkh.getNewYear;
