...
export const TRANSLATIONS: Record<string, { km: string; en: string }> = {
  ...
  'att.sms': { km: 'ប្រព័ន្ធគ្រប់គ្រងសាលា SMS v2.0', en: 'School Management System SMS v2.0' },
  'att.studentTab': { km: 'វត្តមានសិស្សានុសិស្ស', en: 'Student Attendance' },
  'att.teacherTab': { km: 'វត្តមានគ្រូបង្រៀន', en: 'Teacher Attendance' },
  'att.searchStudent': { km: 'ស្វែងរកតាមឈ្មោះសិស្ស', en: 'Search by student name' },
  'att.dailyRateStudent': { km: 'អត្រាវត្តមានសរុបប្រចាំថ្ងៃ៖', en: 'Overall daily attendance rate:' },
  'att.teachers': { km: 'គ្រូបង្រៀន', en: 'Teachers' },
  'att.searchTeacher': { km: 'ស្វែងរកតាមឈ្មោះ ឬថ្នាក់ទទួលបន្ទុក', en: 'Search by name or assigned class' },
  'att.dailyRateTeacher': { km: 'អត្រាវត្តមានគ្រូប្រចាំថ្ងៃ៖', en: 'Daily teacher attendance rate:' },
  'att.totLate': { km: 'សរុបយឺត (យ)', en: 'Total Late (L)' },
  'att.totPerm': { km: 'សរុបច្បាប់ (ច្ប)', en: 'Total Excused (E)' },
  'att.totUnexcused': { km: 'សរុបអត់ច្បាប់ (អច្ប)', en: 'Total Unexcused (A)' },
  'att.totAbsence': { km: 'សរុបអវត្តមាន', en: 'Total Absences' },
  'att.setStatus': { km: 'ជ្រើសរើសវត្តមាន', en: 'Set Attendance' },
  'att.selectReason': { km: '-- ជ្រើសរើសមូលហេតុ --', en: '-- Select reason --' },
  'att.noStudents': { km: 'ពុំមានគណនីសិស្សនៅក្នុងថ្នាក់ត្រូវបានរកឃើញទេ ឬមិនត្រូវនឹងការស្វែងរករបស់អ្នកឡើយ។', en: 'No student accounts found in this class, or none match your search.' },
  'att.saveAllStudent': { km: 'រក្សាទុកវត្តមានទាំងអស់', en: 'Save All Attendance' },
  'att.teacherName': { km: 'ឈ្មោះគ្រូបង្រៀន', en: 'Teacher Name' },
  'att.teacherClass': { km: 'បង្រៀនថ្នាក់រៀន/ជំនាញ', en: 'Class / Subject' },
  'att.noTeachers': { km: 'ពុំមានគណនីគ្រូបង្រៀនត្រូវបានរកឃើញឡើយ ឬមិនត្រូវនឹងការស្វែងរករបស់អ្នក។', en: 'No teacher accounts found, or none match your search.' },
  'att.saveTeacher': { km: 'រក្សាទុកវត្តមានគ្រូ', en: 'Save Teacher Attendance' },
  'att.abbr.present': { km: 'វ', en: 'P' },
  'att.abbr.late': { km: 'យ', en: 'L' },
  'att.abbr.permission': { km: 'ច្ប', en: 'E' },
  'att.abbr.absent': { km: 'អច្ប', en: 'A' },
  'att.tt.present': { km: 'វត្តមាន (វ)', en: 'Present (P)' },
  'att.tt.late': { km: 'យឺត (យ)', en: 'Late (L)' },
  'att.tt.permission': { km: 'ច្បាប់ (ច្ប)', en: 'Excused (E)' },
  'att.tt.absent': { km: 'អត់ច្បាប់ (អច្ប)', en: 'Unexcused (A)' },
  'att.tt.prevDay': { km: 'ថ្ងៃមុន', en: 'Previous day' },
  'att.tt.nextDay': { km: 'ថ្ងៃបន្ទាប់', en: 'Next day' },
  'att.tt.totLate': { km: 'សរុបយឺត', en: 'Total Late' },
  'att.tt.totPerm': { km: 'សរុបច្បាប់', en: 'Total Excused' },
  'att.tt.totUnexcused': { km: 'សរុបអត់ច្បាប់', en: 'Total Unexcused' },
  'att.tt.totAbsence': { km: 'សរុបអវត្តមានសរុប (ច្បាប់ + អត់ច្បាប់)', en: 'Total Absences (Excused + Unexcused)' },

  // Login portal
  'login.kingdom': { km: 'ព្រះរាជាណាចក្រកម្ពុជា', en: 'Kingdom of Cambodia' },
  'login.motto': { km: 'ជាតិ សាសនា ព្រះមហាក្សត្រ', en: 'Nation, Religion, King' },
  'login.welcome': { km: 'សូមស្វាគមន៍មកកាន់ប្រព័ន្ធគ្រប់គ្រងពិន្ទុសិស្ស និងរបាយការណ៍សាលារៀនប្រចាំខែ។', en: 'Welcome to the student-scores and monthly school-report management system.' },
  'login.sampleAccounts': { km: 'ព័ត៌មានគណនីគំរូសាកល្បង៖', en: 'Demo account details:' },
  ...
  'login.deleteAccount': { km: 'លុបគណនីនេះ', en: 'Delete this account' },
  'login.addClass': { km: 'បន្ថែមថ្នាក់ថ្មី', en: 'Add new class' },
  'login.parentAccess': { km: 'មាតាបិតា — មើល/ទាញយកព្រឹត្តបត្រកូន', en: "Parents — view / download your child's report" },
  'login.studentTest': { km: 'សិស្ស — ចូលធ្វើតេស្ត', en: 'Students — take a test' },
  'login.backToSelect': { km: '← ចាកចេញ ទៅជ្រើសរើសគណនីឡើងវិញ', en: '← Back to account selection' },
  'login.principalRole': { km: 'នាយកសាលាសហគមន៍', en: 'Community School Principal' },
  'login.teacherRole': { km: 'គ្រូបន្ទុកថ្នាក់', en: 'Class teacher' },
  'login.enterPin': { km: 'បញ្ចូលលេខកូដសម្ងាត់ (PIN)', en: 'Enter PIN' },
  'login.verify': { km: 'ផ្ទៀងផ្ទាត់ និងចូលគណនី', en: 'Verify and sign in' },
  'login.addClassModal': { km: 'បន្ថែមថ្នាក់ថ្មី (គណនីគ្រូ)', en: 'Add new class (teacher account)' },
  'login.classType': { km: 'ប្រភេទថ្នាក់', en: 'Class type' },
  'login.subjectGroup': { km: 'មុខវិជ្ជា និងក្រុម', en: 'Subject and group' },
  'login.classNameField': { km: 'ថ្នាក់សិក្សា', en: 'Class' },
  'login.classNamePlaceholder': { km: 'ឧទាហរណ៍៖ ថ្នាក់ទី ៧ក', en: 'e.g. Grade 7A' },
  'login.teacherNameField': { km: 'ឈ្មោះលោកគ្រូ-អ្នកគ្រូ', en: 'Teacher name' },
  'login.teacherNamePlaceholder': { km: 'ឈ្មោះគ្រូបន្ទុកថ្នាក់', en: "Class teacher's name" },
  'login.setPin': { km: 'កំណត់លេខកូដសម្ងាត់ (PIN)', en: 'Set PIN' },
  'login.pinDefault': { km: 'លំនាំដើមគឺលេខ 1234 ប៉ុន្តែអ្នកអាចដូរបាន។', en: 'The default is 1234, but you can change it.' },
  'login.classNameLabel': { km: 'ឈ្មោះថ្នាក់៖', en: 'Class name:' },
  'login.wrongPin': { km: 'លេខកូដសម្ងាត់មិនត្រឹមត្រូវទេ!', en: 'Incorrect PIN!' },

  // Parent Portal
  'parent.motto': { km: 'វិជ្ជាសម្បទា · បំណិនសម្បទា · ចរិយាសម្បទា', en: 'Knowledge · Skills · Character' },
  'parent.tile.results': { km: 'លទ្ធផលសិក្សា', en: 'Study Results' },
  'parent.tile.test': { km: 'តេស្តអនឡាញ (Online)', en: 'Online Test' },
  'parent.tile.plp': { km: 'ថ្នាលបឋម (PLP)', en: 'Primary Platform (PLP)' },
  'parent.tile.elibrary': { km: 'បណ្ណាល័យអេឡិចត្រូនិច', en: 'E-Library' },
  'parent.selectClass': { km: 'ជ្រើសរើសថ្នាក់រៀន', en: 'Select a class' },
  'parent.selectClassOpt': { km: '— ជ្រើសរើសថ្នាក់ —', en: '— Select a class —' },
  'parent.typeName': { km: 'វាយឈ្មោះកូនរបស់អ្នក', en: "Type your child's name" },
  'parent.namePlaceholder': { km: 'ឧ. ស៊ុំ សំណាង', en: 'e.g. Sum Samnang' },
  'parent.search': { km: 'ស្វែងរក', en: 'Search' },
  'parent.manyMatches': { km: 'មានឈ្មោះស្រដៀងគ្នាច្រើន — សូមជ្រើសរើស៖', en: 'Several similar names — please choose:' },
  'parent.selected': { km: 'បានជ្រើសរើស៖', en: 'Selected:' },
  'parent.pickReport': { km: 'ជ្រើសរើសព្រឹត្តបត្រដើម្បីមើល / ទាញយក PDF', en: 'Choose a report to view / download as PDF' },
  'parent.monthly': { km: 'ប្រចាំខែ', en: 'Monthly' },
  'parent.semAnnual': { km: 'ឆមាស / ប្រចាំឆ្នាំ', en: 'Semester / Annual' },
  ...
  'parent.err.fetch': { km: 'មិនអាចទាញទិន្នន័យបានទេ — សូមពិនិត្យការតភ្ជាប់អ៊ីនធឺណិត រួចព្យាយាមម្ដងទៀត។', en: 'Could not load data — check your internet connection and try again.' },
  'parent.err.noName': { km: 'រកមិនឃើញឈ្មោះនេះក្នុងថ្នាក់ — សូមពិនិត្យអក្ខរាវិរុទ្ធ រួចព្យាយាមម្ដងទៀត។', en: 'That name was not found in the class — check the spelling and try again.' },
  'parent.weeklyTimetable': { km: 'កាលវិភាគសិក្សាប្រចាំសប្តាហ៍', en: 'Weekly Timetable' },
  'parent.schoolBooks': { km: 'សៀវភៅសាលា', en: 'School books' },
  'parent.monthPrefix': { km: 'ខែ', en: '' },
  // Khmer month names → English, for report-picker labels
  'month.មករា': { km: 'មករា', en: 'January' },
  'month.កុម្ភៈ': { km: 'កុម្ភៈ', en: 'February' },
  'month.មីនា': { km: 'មីនា', en: 'March' },
  'month.មេសា': { km: 'មេសា', en: 'April' },
  'month.ឧសភា': { km: 'ឧសភា', en: 'May' },
  'month.មិថុនា': { km: 'មិថុនា', en: 'June' },
  'month.កក្កដា': { km: 'កក្កដា', en: 'July' },
  'month.សីហា': { km: 'សីហា', en: 'August' },
  'month.កញ្ញា': { km: 'កញ្ញា', en: 'September' },
  'month.តុលា': { km: 'តុលា', en: 'October' },
  'month.វិច្ឆិកា': { km: 'វិច្ឆិកា', en: 'November' },
  'month.ធ្នូ': { km: 'ធ្នូ', en: 'December' },
  'login.saveClass': { km: 'រក្សាទុកថ្នាក់', en: 'Save class' },
  'login.cancel': { km: 'បោះបង់', en: 'Cancel' },
  'login.catGeneral': { km: '📘 ថ្នាក់ចំណេះទូទៅ', en: '📘 General Classes' },
  'login.catExtra': { km: '🎨 ថ្នាក់ក្រៅម៉ោង', en: '🎨 After-hours Classes' },
};
