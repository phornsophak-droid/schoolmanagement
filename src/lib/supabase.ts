...
export function mapScoreToDB(score: StudentScore) {
  return {
    ...
    extra_data: {
      ...
      englishName: score.englishName ?? null,
      dob: score.dob ?? null,
      fatherName: score.fatherName ?? null,
      fatherJob: score.fatherJob ?? null,
      motherName: score.motherName ?? null,
      motherJob: score.motherJob ?? null,
      birthPlace: score.birthPlace ?? null,
...
export function mapDBToScore(db: any): StudentScore {
  ...
  return {
    ...
    englishName: db.extra_data?.englishName ?? undefined,
    dob: db.extra_data?.dob ?? undefined,
    fatherName: db.extra_data?.fatherName ?? undefined,
    fatherJob: db.extra_data?.fatherJob ?? undefined,
    motherName: db.extra_data?.motherName ?? undefined,
    motherJob: db.extra_data?.motherJob ?? undefined,
    birthPlace: db.extra_data?.birthPlace ?? undefined,
    address: db.extra_data?.address ?? undefined,
    phone: db.extra_data?.phone ?? undefined,
