              ...
              <svg className="absolute inset-0 w-full h-full pointer-events-none z-10" viewBox="0 0 1000 707">
                <defs>
                  <linearGradient id="goldGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                    ...
                    <stop offset="20%" stopColor="#fde08b" />
                    <stop offset="50%" stopColor="#d0a747" />
                    <stop offset="80%" stopColor="#fde08b" />
                  ...
                  <pattern id="guillochePattern" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
                    <path d="M 0 50 Q 25 0 50 50 T 100 50" fill="none" stroke="#0f2249" strokeWidth="0.5" opacity="0.05" />
                    <path d="M 0 50 Q 25 100 50 50 T 100 50" fill="none" stroke="#0f2249" strokeWidth="0.5" opacity="0.05" />
                  </pattern>
                </defs>
                
                {/* Background & Watermark */}
                <rect x="0" y="0" width="1000" height="707" fill="#ffffff" />
                <rect x="0" y="0" width="1000" height="707" fill="url(#guillochePattern)" />
                
                {/* Outer Thick Dark Blue Frame with elegant chamfered corners */}
                <polygon points="30,80 80,30 920,30 970,80 970,627 920,677 80,677 30,627" fill="#0f2249" />
                
                {/* Outer Gold Border on the edge of the blue frame */}
                <polygon points="26,78 78,26 922,26 974,78 974,629 922,681 78,681 26,629" fill="none" stroke="url(#goldGradient)" strokeWidth="3.5" />
                
                {/* Inner White Area */}
                <polygon points="45,90 90,45 910,45 955,90 955,617 910,662 90,662 45,617" fill="#ffffff" />
                
                {/* Inner Thick Gold Border */}
                <polygon points="55,95 95,55 905,55 945,95 945,612 905,652 95,652 55,612" fill="none" stroke="url(#goldGradient)" strokeWidth="6" />
                
                {/* Inner Thin Blue Line */}
                <polygon points="63,100 100,63 900,63 937,100 937,607 900,644 100,644 63,607" fill="none" stroke="#0f2249" strokeWidth="1.5" />
                
                {/* Inner Thin Gold Line */}
                <polygon points="70,105 105,70 895,70 930,105 930,602 895,637 105,637 70,602" fill="none" stroke="url(#goldGradient2)" strokeWidth="1" />
                
                {/* Corner Elegant Accents (Over the blue frame) */}
                <g fill="none" stroke="url(#goldGradient)" strokeWidth="2">
                  {/* Top Left */}
                  <path d="M 15 100 C 40 100, 60 80, 60 55 C 60 30, 80 10, 105 10" />
                  <circle cx="15" cy="100" r="4" fill="url(#goldGradient)" />
                  <circle cx="105" cy="10" r="4" fill="url(#goldGradient)" />
                  <path d="M 85 85 L 110 60 M 85 85 L 60 110" strokeWidth="1" />
                  <circle cx="85" cy="85" r="3" fill="#ffffff" />

                  {/* Top Right */}
                  <path d="M 985 100 C 960 100, 940 80, 940 55 C 940 30, 920 10, 895 10" />
                  <circle cx="985" cy="100" r="4" fill="url(#goldGradient)" />
                  <circle cx="895" cy="10" r="4" fill="url(#goldGradient)" />
                  <path d="M 915 85 L 890 60 M 915 85 L 940 110" strokeWidth="1" />
                  <circle cx="915" cy="85" r="3" fill="#ffffff" />

                  {/* Bottom Left */}
                  <path d="M 15 607 C 40 607, 60 627, 60 652 C 60 677, 80 697, 105 697" />
                  <circle cx="15" cy="607" r="4" fill="url(#goldGradient)" />
                  <circle cx="105" cy="697" r="4" fill="url(#goldGradient)" />
                  <path d="M 85 622 L 110 647 M 85 622 L 60 597" strokeWidth="1" />
                  <circle cx="85" cy="622" r="3" fill="#ffffff" />

                  {/* Bottom Right */}
                  <path d="M 985 607 C 960 607, 940 627, 940 652 C 940 677, 920 697, 895 697" />
                  <circle cx="985" cy="607" r="4" fill="url(#goldGradient)" />
                  <circle cx="895" cy="697" r="4" fill="url(#goldGradient)" />
                  <path d="M 915 622 L 890 647 M 915 622 L 940 597" strokeWidth="1" />
                  <circle cx="915" cy="622" r="3" fill="#ffffff" />
                </g>
                
                {/* Inner Filigree Anchors */}
                <g fill="none" stroke="url(#goldGradient)" strokeWidth="1.5">
                  <path d="M 115 115 L 160 115 M 115 115 L 115 160" />
                  <circle cx="115" cy="115" r="5" fill="url(#goldGradient)" />
                  <circle cx="115" cy="115" r="2" fill="#ffffff" />

                  <path d="M 885 115 L 840 115 M 885 115 L 885 160" />
                  <circle cx="885" cy="115" r="5" fill="url(#goldGradient)" />
                  <circle cx="885" cy="115" r="2" fill="#ffffff" />

                  <path d="M 115 592 L 160 592 M 115 592 L 115 547" />
                  <circle cx="115" cy="592" r="5" fill="url(#goldGradient)" />
                  <circle cx="115" cy="592" r="2" fill="#ffffff" />

                  <path d="M 885 592 L 840 592 M 885 592 L 885 547" />
                  <circle cx="885" cy="592" r="5" fill="url(#goldGradient)" />
                  <circle cx="885" cy="592" r="2" fill="#ffffff" />
                </g>
              </svg>
