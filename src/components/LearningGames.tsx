...
const GAMES: Game[] = [
  { id: 'khmer-alphabet', emoji: '🔠', title: '១. អក្ខរក្រមខ្មែរ', description: 'រៀនអាន និងស្គាល់តួអក្សរខ្មែរ (ព្យញ្ជនៈ និងស្រៈ) ជាមួយនឹងហ្គេមទាយអក្សរ', color: '#3B82F6' },
  { id: 'khmer-reading', emoji: '📚', title: '២. ល្បែងអានពាក្យ', description: 'ជួយពង្រឹងការអាន ការផ្គូផ្គង និងការប្រកបពាក្យខ្មែរតាមរយៈរូបភាព និងសំឡេង', color: '#F59E0B' },
  { id: 'find-pairs', emoji: '🔗', title: '៣. ស្វែងរកគូ', description: 'អូសខ្សែភ្ជាប់ពាក្យទៅនឹងរូបភាព។', color: '#EC4899' },
  { id: 'match-word', emoji: '🖼️', title: '៤. ផ្គូផ្គងរូបភាពនិងពាក្យ', description: 'រៀនពាក្យខ្មែរតាមរយៈរូបភាព។', color: '#10B981' },
  { id: 'memory', emoji: '🧠', title: '៥. ល្បែងចងចាំ', description: 'បើកកាតផ្គូផ្គងរូប និងពាក្យដើម្បីហ្វឹកហាត់ការចងចាំ។', color: '#F97316' },
  { id: 'flashcards', emoji: '📇', title: '៦. ប័ណ្ណពាក្យ', description: 'កាតពាក្យសម្រាប់ទន្ទេញមេរៀន។', color: '#06B6D4' },
  { id: 'tts', emoji: '🔊', title: '៧. អានអត្ថបទ', description: 'វាយអត្ថបទ ហើយឱ្យកុំព្យូទ័រអានជាសំឡេង។', color: '#84CC16' },
  { id: 'guess-word', emoji: '📝', title: '៨. ល្បែងទាយពាក្យ', description: 'ទាយអក្សរដើម្បីបំពេញពាក្យឱ្យបានត្រឹមត្រូវ។', color: '#3B82F6' },
  { id: 'money', emoji: '💵', title: '៩. ស្គាល់លុយរៀល', description: 'រៀនរាប់ និងគិតលុយអាប់ជារូបិយបណ្ណខ្មែរ។', color: '#10B981' },
  { id: 'fraction', emoji: '🍕', title: '១០. ល្បែងប្រភាគ', description: 'រៀនពីប្រភាគតាមរយៈការលាបពណ៌រង្វង់នំផាយ។', color: '#EF4444' },
  { id: 'fast-math', emoji: '⚡', title: '១១. បូកដកលេខរហ័ស', description: 'គិតលេខឱ្យលឿនមុនពេលអស់ម៉ោង។', color: '#EAB308' },
  { id: 'multiplication', emoji: '✖️', title: '១២. មេគុណ និងចែក', description: 'ហ្វឹកហាត់មេគុណសម្រាប់កុមារ។', color: '#8B5CF6' },
  { id: 'guess-time', emoji: '⏰', title: '១៣. ល្បែងទាយម៉ោង', description: 'រៀនមើលម៉ោង និងនាទីឱ្យបានត្រឹមត្រូវ។', color: '#EF4444' },
  { id: 'geometry', emoji: '🔺', title: '១៤. រាងធរណីមាត្រ', description: 'ស្គាល់រាងផ្សេងៗដូចជា ត្រីកោណ ចតុកោណ។', color: '#EF4444' },
  { id: 'sort-letters', emoji: '🔠', title: '១៥. តម្រៀបអក្សរ', description: 'រៀបអក្សរឱ្យចេញជាពាក្យត្រឹមត្រូវ។', color: '#6366F1' },
  { id: 'even-odd', emoji: '🔢', title: '១៦. លេខគូ និងសេស', description: 'ញែកឱ្យដាច់រវាងលេខគូ និងលេខសេស។', color: '#06B6D4' },
  { id: 'randomizer', emoji: '🎲', title: '១៧. ចាប់លេខចៃដន្យ', description: 'ចាប់លេខរៀងដោយចៃដន្យ (Randomizer)។', color: '#EF4444' },
  { id: 'timer', emoji: '⏱️', title: '១៨. នាឡិកាកំណត់ម៉ោង', description: 'សម្រាប់កំណត់ពេលធ្វើលំហាត់ក្នុងថ្នាក់។', color: '#3B82F6' },
  { id: 'counting', emoji: '🍎', title: '១៩. រាប់ចំនួន', description: 'រាប់រូបភាព ហើយចុចលេខឱ្យបានត្រឹមត្រូវ។', color: '#EF4444' },
  { id: 'compare-numbers', emoji: '⚖️', title: '២០. ប្រៀបធៀបចំនួន', description: 'ជ្រើសសញ្ញា < = > សម្រាប់ចំនួនពីរ។', color: '#14B8A6' },
  { id: 'sequence', emoji: '➡️', title: '២១. បំពេញលេខបន្ត', description: 'រកលេខដែលបាត់ក្នុងលំដាប់លេខ។', color: '#8B5CF6' },
  { id: 'pattern', emoji: '🔷', title: '២២. លំនាំបន្ត', description: 'ទាយរូបភាពដែលនៅបន្ទាប់ក្នុងលំនាំ។', color: '#0EA5E9' },
  { id: 'colors', emoji: '🎨', title: '២៣. ស្គាល់ពណ៌', description: 'មើលពណ៌ ហើយចុចឈ្មោះពណ៌ឱ្យត្រូវ។', color: '#EC4899' },
  { id: 'word-wheel', emoji: '🎡', title: '២៤. កងវិលចាប់ពាក្យ', description: 'បង្វិលកងដើម្បីរើសរើសពាក្យដោយចៃដន្យ។', color: '#EAB308' },
